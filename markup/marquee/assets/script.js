(() => {
  class Marquee {
    ...
    static init(s = { selector: 'landing-block-node-marquee-link' }) {
  ...
  window.TwpxMarquee = Marquee;
  window.TwpxMarquees = window.TwpxMarquees || [];

  document.querySelectorAll('.landing-block-node-marquee-link');
})();
